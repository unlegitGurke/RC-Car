...
\lstdefinelanguage{CSS}{
  keywords={color,background,margin,padding,font,weight,display,position,top,left,right,bottom,list,style,border,size,white,space,min,width,height,transition,transform},
  sensitive=true,
  morecomment=[l]{//},
  morecomment=[s]{/}{/},
  morestring=[b]',
